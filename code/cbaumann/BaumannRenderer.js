...
///
import * as THREE from '../lib/modules.js'
...
///
export default class BaumannRenderer {
    ...
    constructor( {
        ...
        ambient = 0xCD5C5C,
        //e = 100,000
        cam = { fov: 60, aspect: height/width, near: 1e-3, far: 1e5},
        sunlight = 0xFEF5E7,
        groundlight = 0x581845,
        updateVAR: (time) = >{},
        position = {x:0, y:30, z:45},
    }={} ) {
        ...
        ///
        let sun = new YourImportedStuff.HemisphereLight(sunlight, groundlight, 2)
