...
export default class AdrienneRenderer {
    ...
    constructor({
        ...
        ///
        /// (4) You should pick a sensible import name instead of `T`,
        ///     when you import *en masse*, you need a way to refer to everything.
        ///
        let clock = new T.Clock()
        let listener = new T.AudioListener()
        ///
        ...
        let scene = new T.Scene()
            ...
            ///
            scene.add(new T.AmbientLight(ambient))
        ...
        ///
        let camera = new T.PerspectiveCamera(cam.fov, cam.aspect)
