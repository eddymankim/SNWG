...
function NatureNode(numRootBranches, nodeColor, ) {
    var node = new THREE.Object3D();
    
    for(var i = 0; i < numRootBranches) {
...
// branches
function Branch(radTop, radBottom, height, radSegments, branchColor) {
    var root = new THREE.Object3D();
    
    var branchGeo = new THREE.CylinderGeometry(radTop, radBottom, height, radSegments);
    ...
    rightEnd.position.x = height;
    rightEnd.id = "right";
    
    var leftEnd = new THREE.Group();
    leftEnd.position.x = height;
    leftEnd.id = "left";
