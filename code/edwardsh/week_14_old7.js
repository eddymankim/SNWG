...
function world1() {
    for(var i = 0; i < natureSources.length; i++) {
        natureSources[i].updateMatrixWorld();
...
function world2() {
    for(var i = 0; i < natureSources.length; i++) {
        ...
        natureSources[i].getObjectByName("brace1").rotation.x = Math.PI / 4;
        natureSources[i].getObjectByName("brace2").rotation.z = -Math.PI / 4;
        natureSources[i].getObjectByName("brace3").rotation.x = -Math.PI / 4;
        natureSources[i].getObjectByName("brace4").rotation.z = Math.PI / 4;
...
function world3() {
    for(var i = 0; i < natureSources.length; i++) {
        ...
        natureSources[i].getObjectByName("brace2").rotation.x = Math.PI / 2;
        natureSources[i].getObjectByName("brace3").rotation.z = Math.PI / 2;
        
        natureSources[i].rotation.y = Math.PI / 4;
    }
}
...
function world4() {
    for(var i = 0; i < natureSources.length; i++) {
        ...
        var offset1 = (Math.random() * 0.25) - 0.125;
        var offset2 = (Math.random() * 0.25) - 0.125;
        var offset3 = (Math.random() * 0.25) - 0.125;
        
        natureSources[i].getObjectByName("brace2").rotation.x = (Math.PI / 2) + offset1;
        natureSources[i].getObjectByName("brace3").rotation.z = (Math.PI / 2) + offset2;
        
        natureSources[i].getObjectByName("brace1").rotation.z = offset3;
        natureSources[i].getObjectByName("brace4").rotation.z = (Math.PI / 2) + offset2;
...
function world5() {
    for(var i = 0; i < natureSources.length; i++) {
        ...
        var offset2 = (Math.random() * 0.25) - 0.125;
        var offset3 = (Math.random() * 0.25) - 0.125;
        var offset4 = (Math.random() * 0.25) - 0.125;
        var offset5 = (Math.random() * 0.25) - 0.125;
        
        natureSources[i].getObjectByName("brace1").rotation.x = (Math.PI / 4) + offset1;
        natureSources[i].getObjectByName("brace2").rotation.z = (-Math.PI / 4) + offset2;
        natureSources[i].getObjectByName("brace3").rotation.x = (-Math.PI / 4) + offset3;
        natureSources[i].getObjectByName("brace4").rotation.z = (Math.PI / 4) + offset4;
        
        natureSources[i].rotation.y = offset5;
    }
}
...
// braces that move to change the experience
function Brace(x, y, z) {
    var base = new THREE.Object3D();
    
    var braceGeo = new THREE.BoxGeometry(x, y, z);
    var braceMat = new THREE.MeshLambertMaterial( { color: Colors.blue, transparent: true, opacity: 1  } );
