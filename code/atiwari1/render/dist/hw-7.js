...
function hexagons() {
    ...
    var hexes = [];
    for (var i = 0; i < 6; i++) {
        var pos = start.clone().add(basis).applyAxisAngle(new THREE.Vector3(0, 1, 0), r2d(i * 60));
        var hex = hexagon(2, 2);
...
function bathtub(i) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, load_collada(bathtubs[0])];
                case 1:
                    col = _a.sent();
                    childs = col.scene.children;
                    return [2 /*return*/];
            }
        });
    });
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var start, renderer, col, first_ring;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    renderer.add.apply(renderer, hexagons());
