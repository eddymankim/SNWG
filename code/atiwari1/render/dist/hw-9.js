...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var parser, voxelData, param, builder, mesh, renderer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    parser = new vox.Parser();
                    return [4 /*yield*/, parser.parse('/data/atiwari1/Palace3.vox')];
                case 1:
                    voxelData = _a.sent();
                    param = { voxelSize: 5 };
                    builder = new vox.MeshBuilder(voxelData, {
                        voxelSize: 5
                    });
