...
export default class OutlinePass extends Pass {
    static const BlurDirectionX = new THREE.Vector2(1.0,0.0)
    static const BlurDirectionY = new THREE.Vector2(0.0,1.0)
    constructor(resolution, scene, camera, selectedObjects) { super()
        const copyShader = THREE.CopyShader // copy material
